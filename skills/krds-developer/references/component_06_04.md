Title: 태그 (Tag) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_06_04.html
...
1. 1.**레이블**태그를 통해 전달하고자 하는 메타 데이터
2. 2.**컨테이너**태그를 배경과 구분하는 윤곽선 또는 배경색
3. 3.**삭제 아이콘**레이블과 관련된 데이터의 필터링을 해제할 수 있음을 안내함
4. 4.**일괄 액션 버튼**태그 그룹 우측에 배치되어 전체 그룹에 대해 한 번에 동일한 동작을 수행하는 데 사용되는 버튼
5. 5.**더 보기 버튼**표와 같이 공간이 제한되어 있는 경우 그룹 내 일부 토큰을 숨길 수 있음
...
__상호작용 가이드라인 태그 탐색과 실행에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Tab, Space, Enter 로 구성되어있음__
| 구분           | 설명                                                                                                                     |
| ------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
__상호작용 가이드라인 태그 선택에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Space 로 구성되어있음__
| 구분    | 설명                                                                                                     |
| ----- | ------------------------------------------------------------------------------------------------------ |
...
__상호작용 가이드라인 태그 삭제에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Space 로 구성되어있음__
| 구분    | 설명                                                                                                                                                           |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
<!-- Source: https://www.krds.go.kr/html/code/tag.html -->
```html
<!-- tag -->
...
<!-- KRDS-CODE:START 링크형 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/tag_link.html -->
```html
<!-- tag -->
<div class="krds-tag-wrap large">
