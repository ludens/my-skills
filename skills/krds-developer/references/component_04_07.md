Title: 아코디언 (Accordion) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_04_07.html

Markdown Content:
---
description: 아코디언은 한 페이지에서 관련 있는 여러 콘텐츠 섹션을 확인할 수 있도록 하는 컴포넌트로 콘텐츠 섹션의 헤더 목록이 수직으로 쌓여 있는 형태로 표현된다. 일반적으로 헤더 목록은 컨트롤 요소로 활용되며 사용자는 필요에 따라 헤더를 선택하여 하위 콘텐츠 섹션을 표시하거나 숨길 수 있다.
title: 아코디언 (Accordion) | 컴포넌트 - KRDS
...
1. 1.**헤더**  
   1. a.**제목** 패널 섹션의 콘텐츠 제목  
   2. b.**아이콘** 패널의 펼침/접힘 상태를 나타냄
2. 2.**패널** 헤더 하위에 속하는 콘텐츠 섹션
...
__상호작용 가이드라인 헤더 목록 탐색에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Tab, Shift + Tab 로 구성되어있음__
| 구분               | 설명                          |
| ---------------- | --------------------------- |
...
__상호작용 가이드라인 패널 확장 또는 축소에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                             |
| ------------ | ------------------------------------------------------------------------------ |
...
<!-- Source: https://www.krds.go.kr/html/code/accordion.html -->
```html
<!-- accordion -->
...
<!-- KRDS-CODE:START 라인형 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/accordion_line.html -->
```html
<!-- accordion -->
...
| 함수명               | 설명      |                 |
| ----------------- | ------- | --------------- |
| krds\_accordion   | init()  | 초기화 및 주요 이벤트 실행 |
