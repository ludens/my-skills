Title: 신청서 작성 | 서비스 패턴 - 신청 - KRDS

URL Source: https://www.krds.go.kr/html/site/service/service_04_05.html

Markdown Content:
---
description: 값의 변경이 이전에 작성한 항목 또는 이전 단계에 영향을 미치는 상황에 대해 사용자에게 안내해야 한다.
title: 신청서 작성 | 서비스 패턴 - 신청 - KRDS
...
1. 1.**제목** 입력폼의 목적에 대한 설명
2. 2.**설명(선택)** 신청의 목적에 대한 부가적인 설명이나 사용자가 데이터를 입력할 때 유의해야 하는 사항 등 총체적인 안내를 제공하는 문장
3. 3.**입력폼** 신청서 작성에 필요한 데이터를 입력하기 위한 양식
4. 4.**단계 표시기** 작성의 단계가 있는 신청에서 현재 진행 중인 단계를 안내하기 위해 제공됨
5. 5.**도움 패널** 신청서 작성에 필요한 도움말, 관련하여 참고할 수 있는 정보의 링크, 문의처 정보가 제공됨
6. 6.**어노테이션 아이콘** 도움 패널을 실행하는 데 사용되는 버튼
...
| ---------------- | ---------------------------------------------------------------------------------------- | --------- | ---------------------------------------------------------------------------------------- |
| 신청하기             | 전입신고                                                                                     | 신청인 정보 입력 | [전입신고>신청인 정보 입력 html 화면 확인하기 ](../../pattern/sample%5Fmove%5Fprocess%5F03.html "새 창 열기") |
| 이사 전 살던 곳        | [전입신고>이사 전 살던 곳 html 화면 확인하기 ](../../pattern/sample%5Fmove%5Fprocess%5F04.html "새 창 열기") |           |                                                                                          |
| 이사 온 곳           | [전입신고>이사 온 곳 html 화면 확인하기 ](../../pattern/sample%5Fmove%5Fprocess%5F05.html "새 창 열기")    |           |                                                                                          |
| 건축물대장 등·초본 발급 신청 | [건축물대장 등·초본 발급 신청 html 화면 확인하기 ](../../pattern/sample%5Fappl%5F0301.html "새 창 열기")       |           |                                                                                          |
| 주민등록표등본(초본)교부 신청 | [주민등록표등본(초본)교부 신청 html 화면 확인하기 ](../../pattern/sample%5Fappl%5F0302.html "새 창 열기")       |           |                                                                                          |
| 자료신청             | [자료신청 html 화면 확인하기 ](../../pattern/sample%5Fappl%5F0303.html "새 창 열기")                   |           |                                                                                          |
...
* [개인 식별 정보 입력](./../global/global%5F01.html)
* [도움](./../global/global%5F02.html)
* [동의](./../global/global%5F03.html)
* [입력폼](./../global/global%5F08.html)

#### 컴포넌트

* [단계 표시기](./../component/component%5F07%5F01.html)
* [도움 패널](./../component/component%5F08%5F01.html)
* [맥락적 도움말](./../component/component%5F08%5F03.html)
* [따라하기 패널](./../component/component%5F08%5F02.html)
