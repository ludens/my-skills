Title: 툴팁 (Toolip) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_08_05.html
...
1. 1.**활성화 버튼**툴팁 콘텐츠의 표시를 토글하는 버튼
2. 2.**컨테이너**팝오버 영역과 배경을 구분하는 요소
3. 3.**아이콘(선택)**강조가 필요한 경우, 본문의 내용에 따라 시스템 상태 아이콘을 사용할 수 있음
4. 4.**본문**구체적인 설명 텍스트
...
__상호작용 가이드라인 툴팁 활성화으로 이동에 대한 표로 구분/내용으로 구성되어있으며 구분 항목은 Click, Mouseover, Focus으로 구성되어있음__
| 구분        | 내용                                        |
| --------- | ----------------------------------------- |
...
__상호작용 가이드라인 툴팁 비활성화에 대한 표로 구분/내용으로 구성되어있으며 구분 항목은 Click, Mouseleave, Blur, Esc로 구성되어있음__
| 구분         | 내용                                                                                                                                           |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------- |
...
#### 기본
 ...
 tooltip-horizontal 도움말 도움말 

##### 기본 코드 확인하기

<!-- KRDS-CODE:START 기본 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/tooltip.html -->
```html
<!-- tooltip -->
...
#### tooltip vertical
 ...
 tooltip-vertical 도움말 도움말 

##### tooltip vertical 코드 확인하기

<!-- KRDS-CODE:START tooltip vertical 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/tooltip_vertical.html -->
```html
<!-- tooltip -->
...
<!-- //tooltip -->
```
<!-- KRDS-CODE:END tooltip vertical 코드 확인하기 -->
...
<!-- KRDS-CODE:START tooltip box 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/tooltip_box.html -->
```html
<!-- tooltip -->
...
<!-- //tooltip -->
```
<!-- KRDS-CODE:END tooltip box 코드 확인하기 -->
...
| 함수명                 | 설명           |                 |
| ------------------- | ------------ | --------------- |
| krds\_tooltip       | init()       | 초기화 및 주요 이벤트 실행 |
| setupTooltips()     | 툴팁 설정        |                 |
