Title: 상세 정보 확인 | 기본 패턴 - KRDS

URL Source: https://www.krds.go.kr/html/site/global/global_06.html

Markdown Content:
---
description: 상세 정보는 특정한 주제에 관한 정보를 제공하는 패턴으로, 효과적인 정보 전달을 위해 텍스트 이외에 다양한 시각적 요소들이 활용된다. 사용자들은 콘텐츠 목록에서 콘텐츠 제목이나 요약 정보를 포함한 링크를 통해 상세 정보에 접근하기 때문에, 사용자가 예상하는 정보를 명확하고 간결하게 전달할 수 있어야 한다.
title: 상세 정보 확인 | 기본 패턴 - KRDS
...
4. 4.**부가 정보** 본문에 대한 이해를 돕기 위해 제공되는 콘텐츠 섹션으로 구성됨
5. 5.**콘텐츠 변경 이력** 정보의 업로드일, 변경일, 변경된 내용에 대한 로그 기록
6. 6.**콘텐츠 내 탐색** 본문의 콘텐츠 섹션의 구조를 파악하고 원하는 섹션으로 이동할 수 있도록 도와주는 탐색 수단
7. 7.**액션 버튼** 정보와 관련된 기능을 실행하는 버튼 또는 관련 화면으로 이동할 수 있는 링크
...
| ------ | -------------------------------------------------------------------- | ------ | ------------------------------------------------------------------- |
| 서비스 신청 | 장애아동수당                                                               | 일반형    | [일반형 html 화면 확인하기 ](../../pattern/sample%5Fappl%5F02.html "새 창 열기") |
