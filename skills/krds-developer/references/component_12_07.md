Title: 탭바 (Tab bar) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_12_07.html
...
4. 4.**인디케이터(선택)**선택된 상태임을 알려주는 시각적인 식별자
5. 5.**배지(선택)**표시된 메뉴에 새로운 정보가 제공되거나 사용자의 행동이 필요함을 보여줌
