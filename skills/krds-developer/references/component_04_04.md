Title: 디스클로저 (Disclosure) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_04_04.html

Markdown Content:
---
description: 디스클로저는 특정한 정보/컨트롤/섹션에 관련된 부가적인 정보를 표시하거나 숨기는 데 사용되는 요소이다. 디스클로저 하위 콘텐츠 섹션은 기본으로 축소된 상태로 제공되며 사용자가 요청하는 경우에 확장되어 자세한 정보가 표시된다. 이는 사용자의 인지적 부담을 감소시키고 정보를 빠르게 훑어보는 데 도움이 된다.
title: 디스클로저 (Disclosure) | 컴포넌트 - KRDS
...
1. 1.**꺾쇠 아이콘**콘텐츠 섹션의 확장/축소 상태를 나타냄
2. 2.**텍스트**확장할 콘텐츠 섹션의 내용을 유추할 수 있는 제목 텍스트
3. 3.**컨테이너**정보가 제공되는 콘텐츠 섹션으로 꺾쇠 아이콘이나 텍스트를 눌러 표시하거나 숨길 수 있음
...
__상호작용 가이드라인 디스클로저 탐색에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Tab, Shift + Tab 로 구성되어있음__
| 구분               | 설명                              |
| ---------------- | ------------------------------- |
...
__상호작용 가이드라인 디스클로저 확장 및 축소에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                              |
| ------------ | --------------------------------------------------------------- |
...
<!-- Source: https://www.krds.go.kr/html/code/disclosure.html -->
```html
<!-- disclosure -->
...
| ------ | ------ | ------------------------------------------------------------------- |
| 서비스 신청 | 바구니    | [바구니 html 화면 확인하기 ](../../pattern/sample%5Fcart%5F01.html "새 창 열기") |

### 마크업 가이드

#### CSS 선택자

__마크업 가이드 CSS 선택자에 대한 표로 필수 로 구성되어있으며 구분 항목은 전체영역, 디스클로저 버튼, 컨테이너로 구성되어있음__
| 필수       |                                     |
| -------- | ----------------------------------- |
...
| 함수명                | 설명       |                 |
| ------------------ | -------- | --------------- |
| krds\_disclosure   | init()   | 초기화 및 주요 이벤트 실행 |
