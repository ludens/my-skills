Title: 레이아웃(Layout) | 스타일 가이드 - KRDS

URL Source: https://www.krds.go.kr/html/site/style/style_05.html

Markdown Content:
---
description: 레이아웃(Layout)은 정보 구조와 시각적 흐름을 체계적으로 구성하여 사용자가 콘텐츠를 쉽게 이해할 수 있도록 한다. 레이아웃 가이드는 그리드, 브레이크포인트, 간격 설정을 통해 일관된 사용자 경험을 제공하며, 시각적 일관성과 정보 전달 효과를 높인다.
title: 레이아웃(Layout) | 스타일 가이드 - KRDS
...
__브레이크포인트에 대한 표로 브레이크포인트, 뷰포트, 칼럼 수 (적정-최대), 가터 너비 (최소-적정), 최소 스크린 마진, 대한 내용으로 구성되어 있으며 브레이크포인트는 xsmall, small, medium, large, xlarge, xxlarge 구성되어있다.__
...
__표준형 스타일에 대한 표로 name, Viewport, 칼럼 수 (적정-최대), 가터 너비 (최소-적정), 최소 스크린 마진, 대한 내용으로 구성되어 있으며 name은 small, medium, large, xlarge 구성되어있다.__
...
1. 1.**Header**사용자가 웹사이트에 접속하자마자 마주하게 되는 화면의 최상단 영역
2. 2.**Left menu**서브 화면 내에서의 이동을 위해 사용하는 메뉴**선택사항**
3. 3.**Main contents**사용자가 본문의 구조를 훑어보고 원하는 콘텐츠로 빠르게 이동할 수 있도록 하는 탐색 수단
4. 4.**Right menu**사용자가 본문의 구조를 훑어보고 원하는 콘텐츠로 빠르게 이동할 수 있도록 하는 탐색 수단**선택사항**
5. 5.**Footer**화면을 구성하는 가장 마지막 요소로 헤더와 본문에서 원하는 정보를 찾지 못하였거나 사이트 구조 탐색 중에 길을 잃은 사용자들이 대면하게 되는 정보
...
[사이드 메뉴 ](./../component/component%5F03%5F04.html) 
...
[콘텐츠 내 탐색 ](./../component/component%5F03%5F05.html) [도움 패널 ](./../component/component%5F08%5F01.html) 
...
__반응형 간격 설정에 대한 표로 모드, 범위, 뷰포트, 기준 사이즈 (콘텐츠 영역), 사용에 대한 내용으로 구성되어 있으며 모드는 Mobile,PC 으로 구성되어있다.__
...
__레이아웃트에 대한 표로 브레이크포인트, 뷰포트, 칼럼 수 (적정-최대), 가터 너비 (최소-적정), 최소 스크린 마진, 대한 내용으로 구성되어 있으며 브레이크포인트는 xsmall, xsmall, medium, large, xlarge, xxlarge 구성되어있다.__
...
[타이포그래피 확인하기 ](./../style/style%5F03.html) 
