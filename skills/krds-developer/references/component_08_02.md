Title: 따라하기 패널 (Tutorial panel) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_08_02.html
...
3. 3.**섹션 제목**따라하기 패널 자체의 제목 또는 현재 진행 중인 과업 단계의 텍스트가 제공됨
4. 4.**뒤로 가기 버튼**기본 내용 화면으로 전환하기 위한 버튼
5. 3.**본문**따라하기 패널의 용도를 안내하고 사용을 유도하기 위한 초기 상태와 단계별 상세 안내 정보를 제공하는 두 가지 상태로 구성됨  
   1. a.**기본**따라하기 패널을 실행하였을 때 최초에 제공되는 기본 콘텐츠로 실습에 포함된 과업 목록과 세부 과업을 확인할 수 있음  
   2. b.**실습 단계**기본 콘텐츠에 명시된 과업 목록 하위의 세부 과업 목록. 각 세부 과업의 제목은 코치마크의 제목과 동일함
6. 6.**중단 버튼**진행 중인 따라하기 과정을 중단하는 데 사용되는 버튼
...
__상호작용 가이드라인 패널 실행에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                                                   |
| ------------ | ---------------------------------------------------------------------------------------------------- |
...
__상호작용 가이드라인 패널 내부 콘텐츠 탐색에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Tab, Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                |
| ------------ | ----------------------------------------------------------------- |
...
__상호작용 가이드라인 패널 비활성화에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                                                   |
| ------------ | ---------------------------------------------------------------------------------------------------- |
...
| ------ | ------ | --------------------------------------------------------------------- |
| 신청하기   | 전입신고   | [전입신고 html 화면 확인하기 ](../../pattern/sample%5Fcoach%5F01.html "새 창 열기") |

### 마크업 가이드

#### CSS 선택자

__마크업 가이드 CSS 선택자에 대한 표로 필수/선택으로 구성되어있으며 구분 항목은 전체영역, 영역 전개, 패널 제어 버튼, 패널 본문, 중단 버튼으로 구성되어있음__
| 필수       | 선택                 |       |         |
| -------- | ------------------ | ----- | ------- |
