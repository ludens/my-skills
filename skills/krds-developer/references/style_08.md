Title: 엘리베이션(Elevation) | 스타일 가이드 - KRDS

URL Source: https://www.krds.go.kr/html/site/style/style_08.html

Markdown Content:
---
description: 엘리베이션(Elevation)은 사용자 인터페이스(UI)에서 요소들이 서로 다른 시각적 레벨에 위치하도록 하여 깊이감과 계층 구조를 부여하는 중요한 개념이다.
title: 엘리베이션(Elevation) | 스타일 가이드 - KRDS
