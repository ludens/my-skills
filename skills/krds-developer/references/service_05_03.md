Title: 정보 확인 | 서비스 패턴 - 정책 정보 확인 - KRDS

URL Source: https://www.krds.go.kr/html/site/service/service_05_03.html

Markdown Content:
---
description: 상세 정보는 정확하고 최신화된 상태로 제공한다.모든 상세 정보 텍스트에는 오탈자가 없도록 하고 공식적인 용어와 명칭을 사용해야 한다. 또한 정보에 변경이 필요한 경우 다른 채널보다 우선적으로 내용을 최신화하여 디지털 정부 서비스에 대한 신뢰를 확보해야 한다.
title: 정보 확인 | 서비스 패턴 - 정책 정보 확인 - KRDS
