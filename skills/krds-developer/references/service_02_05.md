Title: 상세 검색 | 서비스 패턴 - 검색 - KRDS

URL Source: https://www.krds.go.kr/html/site/service/service_02_05.html

Markdown Content:
---
description: 기본 정렬, 필터 컨트롤을 제공한다.사용자가 간단한 정렬, 필터 옵션을 활용하여 결과를 좁힐 수 있도록 가장 기본적인 속성에 대한 정렬, 필터 컨트롤을 제공해야 한다. 통합검색의 경우, 검색 기간 필터, 기본 정렬 컨트롤을 제공한다.
title: 상세 검색 | 서비스 패턴 - 검색 - KRDS
...
1. 1.**정렬 컨트롤** 검색 결과 목록의 순서를 변경하는 데 사용되는 컨트롤
2. 2.**필터 컨트롤** 검색 결과 목록을 특정 주제, 범주, 속성으로 제한하는데 사용되는 컨트롤
3. 3.**고급 검색 버튼/링크** 정렬, 필터 컨트롤에서 제공되지 않는 보다 복잡한 검색 조건 설정에 접근할 수 있는 수단
...
__유형 선택 방법에 대한 표로 이동에 대한 표로 구분/기본 검색/복합 검색/고급 검색 구성되어있으며 구분 항목은 검색 범위, 메타 데이터 복잡성 , 검색 결과 정확도, 사용할 필터 유형 로 구성되어있음__
...
권장기본 검색에서 정렬, 필터 컨트롤은 일정한 순서로 제공되어야 한다.
...
| ------------------------------------------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| 통합검색                                                                            | 타입1                                                                         | [통합검색>타입1 html 화면 확인하기 ](../../pattern/sample%5Fquest%5F0102.html "새 창 열기")   |
| 타입2                                                                             | [통합검색>타입2 html 화면 확인하기 ](../../pattern/sample%5Fsearch%5F02.html "새 창 열기")  |                                                                               |
| 서비스 신청                                                                          | 타입1                                                                         | [서비스 신청>타입1-1 html 화면 확인하기 ](../../pattern/sample%5Fquest%5F01.html "새 창 열기") |
| [서비스 신청>타입1-2 html 화면 확인하기 ](../../pattern/sample%5Fquest%5F0101.html "새 창 열기") |                                                                             |                                                                               |
| 타입2                                                                             | [서비스 신청>타입2 html 화면 확인하기 ](../../pattern/sample%5Fquest%5F02.html "새 창 열기") |                                                                               |
