Title: 스플래시 스크린 (Splash screen) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_12_08.html

Markdown Content:
---
description: 스플래시 스크린은 응용 프로그램이 실행되기 전에 사용자에게 짧은 시간 동안 제공되는 화면으로 모바일 애플리케이션 전용 컴포넌트이다.
title: 스플래시 스크린 (Splash screen) | 컴포넌트 - KRDS
...
1. 1.**배경**스플래시 스크린의 시스템 뷰. 브랜드/서비스 아이덴티티, 스타일 테마에 따라 색상이나 배경 이미지가 변경된다.
2. 2.**브랜드 아이덴티티**서비스 로고 이미지
3. 3.**텍스트**브랜드의 특성을 전달하는 메시지
4. 4.**스피너**화면이나 요소의 다양한 처리 상태를 시각적으로 알려주는 컴포넌트
