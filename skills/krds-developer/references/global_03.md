...
URL Source: https://www.krds.go.kr/html/site/global/global_03.html

Markdown Content:
---
description: 동의는 웹사이트의 이용 조건 및 절차 등을 명시한 내용을 읽고 동의 여부나 안내 사항의 확인 여부를 확인하는 데 사용되는 패턴이다. 대개 동의가 필요한 약관은 일반적으로 잘 사용되지 않는 용어로 작성되며 양이 매우 방대하므로 사용자의 이해를 도울 수 있도록 요소들을 알기 쉽게 구조화해야 한다.
title: 동의 | 기본 패턴 - KRDS
...
1. 1.**일괄 동의 옵션**  
   1. a.**체크박스**동의 목록의 전체 항목의 동의 옵션 선택 상태를 토글하는 데 사용됨  
   2. b.**설명**동의하는 항목 전체에 대한 정보와 선택 동의 항목에 대한 설명이 제공됨
2. 2.**목록**  
   1. a.**컨테이너**항목을 다른 항목과 구분하는 시각적 구분자  
   2. b.**제목**동의 목록의 각 항목 제목으로 본문에 제공되고 있는 콘텐츠의 제목에 해당하는 텍스트  
   3. c.**본문**약관 등에 대한 상세 설명  
   4. d.**동의 옵션**항목에 대한 동의 여부를 선택하기 위한 라디오 버튼 또는 체크박스
...
__상호작용 가이드라인 동의 옵션 선택 일괄 선택에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Space 로 구성되어있음__
| 구분    | 설명                                                                                                                                                                                         |
| ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
