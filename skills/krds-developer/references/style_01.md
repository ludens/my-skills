Title: 디자인 스타일 소개 - KRDS

URL Source: https://www.krds.go.kr/html/site/style/style_01.html

Markdown Content:
---
description: 디자인 스타일은 디자인 시스템의 핵심 요소로, 정부 사이트에서 사용자 경험의 일관성과 정부 기관의 신뢰성을 보장하고 사용자 접근성을 강화하기 위해 설계되었다. KRDS의 스타일 가이드는 색상, 타이포그래피, 형태, 레이아웃, 아이콘, 엘리베이션, 디자인 토큰을 체계적으로 정의하여 적용 기관의 요구를 충족하면서도 사용자 중심의 경험을 실현한다. 준수해야 할 기준과 변경 가능한 항목을 명확히 구분해, 디자인 시스템의 효과적인 활용과 적용의 용이성을 돕는다.
title: 디자인 스타일 소개 - KRDS
...
[ 적용 대상 및 기준 자세히 보기 ](./../utility/utility%5F07.html) 
...
[ 자체 검증 체크리스트 바로가기 ](https://www.krds.go.kr/html/site/community/community%5F04%5F01.html?nttId=2) 
...
__정보 변경 내역 표로 krds v0(디지털 정부서비스 UI/UX 가이드라인) krds v1 (범정부 UI/UX 디자인시스템) 으로 구성되어있음__
