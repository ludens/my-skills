Title: 타이포그래피(Typography) | 스타일 가이드 - KRDS

URL Source: https://www.krds.go.kr/html/site/style/style_03.html

Markdown Content:
---
description: 타이포그래피는 정보를 효과적으로 전달하고 일관된 사용자 경험을 제공하는 데 필수적인 요소이다. 글꼴, 크기, 두께, 간격, 계층 구조를 정의하여 가독성을 높이고, 내용을 중요도에 따라 시각적으로 표현한다. 가이드에 맞춘 타이포그래피는 명확한 정보 전달을 가능하게 하며, 다양한 화면에서도 일관된 경험을 제공한다.
title: 타이포그래피(Typography) | 스타일 가이드 - KRDS
...
[ Pretendard GOV 서체 바로가기 ](https://github.com/orioncactus/pretendard/tree/main/packages/pretendard-gov "새 창 열림") 
...
[ 1.4.12 Text Spacing-Level AA ](https://www.w3.org/WAI/WCAG22/quickref/#text-spacing "새 창 열기") 
...
__표현 단위(rem) 에 대한 표로 rem의 기본값, % 기준, px 기준에 대한 내용으로 구성되어 있으며 rem의 기본값은 시스템 기본 폰트 크기 16px 기준으로 구성되어있다.__
| rem의 기본값             | % 기준 | px 기준 |
| -------------------- | ---- | ----- |
...
[ 단위변환 참고 사이트 ](https://sitero.co.kr/fontsize "새 창 열기") 
...
__표현 단위(rem) 에 대한 표로 Style, Size(pc), Size(mobile), Font weight, Line height, Letter spacing, 대한 내용으로 구성되어 있으며 Style은 large, medium, 구성되어있다.__
...
__Heading 에 대한 표로 Style, Size(pc), Size(mobile), Font weight, Line height, Letter spacing, 대한 내용으로 구성되어 있으며 Style은 xxlarge, xlarge, large, medium, small, small 구성되어있다.__
| Style   | Size(pc) | Size(mobile) | Font weight | Line height | Letter spacing |
| ------- | -------- | ------------ | ----------- | ----------- | -------------- |
...
__Heading 에 대한 표로 구조, 범위, 사용 대한 내용으로 구성되어 있으며 구조는 h2, h3, h4, h5, h6 구성되어있다.__
| 구조 | 범위             | 사용                                        |
| -- | -------------- | ----------------------------------------- |
...
__Body 에 대한 표로 Style, Size(pc), Size(mobile), Font weight, Line height, Letter spacing, 대한 내용으로 구성되어 있으며 Style은 large-bold, medium-bold, small-bold, xsmall-bold, large, medium\*, small, xsmall 구성되어있다.__
| Style        | Size(pc) | Size(mobile) | Font weight | Line height | Letter spacing |
| ------------ | -------- | ------------ | ----------- | ----------- | -------------- |
...
__body 에 대한 표로 범위, 사용 대한 내용으로 구성되어 있으며 구조는 범위 large, medium, small, xsmall구성되어있다.__
| 범위     | 사용                                                                   |
| ------ | -------------------------------------------------------------------- |
...
__특정 역할의 토큰 에 대한 표로 Style, Size(pc), Size(mobile), Font weight, Line height, Letter spacing, 대한 내용으로 구성되어 있으며 Style은 title-large, title-small, depth-medium-bold, depth-medium, depth-small-bold, depth-small구성되어있다.__
| Style             | Size(pc) | Size(mobile) | Font weight | Line height | Letter spacing |
| ----------------- | -------- | ------------ | ----------- | ----------- | -------------- |
...
Button Input Check box Radio button 

__특정 역할의 토큰 에 대한 표로 Style, Size(pc), Size(mobile), Font weight, Line height, Letter spacing, 대한 내용으로 구성되어 있으며 Style은 large, medium, small, xsmall구성되어있다.__
| Style  | Size(pc) | Size(mobile) | Font weight | Line height | Letter spacing |
| ------ | -------- | ------------ | ----------- | ----------- | -------------- |
| large  | 19       | 19           | 400         | 150%        | 0px            |
| medium | 17       | 17           | 400         | 150%        | 0px            |
...
[ 텍스트 간격 보기 ](./style%5F05.html#anchor-page-5) 
...
__글자 색상에 대한 표로 등급, 큰 텍스트, 일반 텍스트, 대비율 대한 내용으로 구성되어 있으며 구조는 등급 AA, AAA 구성되어있다.__
| 등급  | 큰 텍스트            | 일반 텍스트           | 대비율 |
| --- | ---------------- | ---------------- | --- |
| AA  | 3:1 (매직넘버: 40)   | 4.5:1 (매직넘버: 50) | 최소  |
| AAA | 4.5:1 (매직넘버: 50) | 7:1 (매직넘버: 70)   | 강화  |

__글자 색상에 대한 텍스트 크기, pt(point) 단위, px(pixel) 단위, 대비율 대한 내용으로 구성되어 있으며 구조는 텍스트 크기 큰 텍스트, 일반 텍스트 구성되어있다.__
...
[ 1.4.3 Contrast (Minimum)-Level AA ](https://www.w3.org/WAI/WCAG22/quickref/#contrast-minimum "새 창 열기") [ 1.4.6 Contrast (Enhanced)-Level AAA ](https://www.w3.org/WAI/WCAG22/quickref/#contrast-enhanced "새 창 열기") 
...
[ 단위변환기 ](https://sitero.co.kr/fontsize "새 창 열기") 
...
[글자 색상 자세히 보기 ](./../style/style%5F02.html) 
