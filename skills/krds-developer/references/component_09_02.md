Title: 텍스트 영역 (Textarea) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_09_02.html
...
1. 1.**레이블**사용자가 어떤 텍스트를 입력해야 하는지를 알려줌
2. 2.**입력 영역**텍스트가 입력되는 영역으로 배경과 입력 영역을 구분하여 사용자가 텍스트 영역임을 인지할 수 있게 함
3. 3.**플레이스홀더(선택)**어떤 값을 입력해야 하는지에 대한 힌트 또는 예시를 제공함
4. 4.**입력된 글자 수**입력 가능한 글자 수와 입력된 글자 수를 안내하는 텍스트
...
__상호작용 가이드라인 마우스에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Scroll 로 구성되어있음__
| 구분     | 설명                                                                                |
| ------ | --------------------------------------------------------------------------------- |
...
__상호작용 가이드라인 키보드에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Tab, Shift + Tab, 방향키 ↑, ↓ 로 구성되어있음__
| 구분               | 설명                                                                                |
| ---------------- | --------------------------------------------------------------------------------- |
...
<!-- Source: https://www.krds.go.kr/html/code/textarea.html -->
```html
<!-- textarea -->
<!-- 폼그룹 -->
...
__마크업 가이드 CSS 선택자에 대한 표로 필수 항목로 구성되어있으며 필수 항목은 전체영역, 텍스트 영역으로 구성되어있음__
| 필수     |                |
| ------ | -------------- |
| 전체영역   | .textarea-wrap |
| 텍스트 영역 | .krds-input    |
