Title: 도움 패널 (Help panel) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_08_01.html
...
1. 1.**패널 열기 버튼** 패널을 표시하는 데 사용되는 버튼. 본문 우측에 배치되며, 스크롤 동작 시 화면의 일관된 위치에 고정하여 배치됨
2. 2.**아이콘 버튼** 도움 패널과 상세 도움 콘텐츠의 표시를 토글하는 ? 아이콘 버튼
3. 3.**식별자** 활성화된 아이콘 버튼을 표시함
4. 4.**헤더**  
   1. a.**패널 선택 탭**도움 패널과 따라하기 패널을 전환하는 데 사용됨  
   2. b.**패널 닫기 버튼**패널을 닫고 패널 활성화 버튼을 표시하는 데 사용됨
5. 5.**본문**도움 패널의 용도를 안내하고, 사용을 유도하기 위한 초기 상태와 대상에 관련된 상세 정보를 제공하는 두 가지 상태로 구성됨  
   1. a.**섹션 제목**도움말을 제공할 대상에 대한 요약 텍스트  
   2. b.**내용**콘텐츠. 필요한 경우 관련 페이지 링크나 파일 다운로드 링크가 포함될 수 있음
6. 6.**구분선**본문과 푸터를 구분하기 위한 선
7. 7.**푸터**  
   1. a.**관련 페이지 링크** 원하는 페이지로 이동하지 못한 사용자를 고려하여, 탐색 중인 페이지와 관련되어 있거나 유사한 내용의 페이지 링크를 대안으로 제공함  
   2. b.**기타 문의/도움말 채널** 관련 질의응답을 확인할 수 있거나 추가적으로 질문할 수 있는 채널(자주 묻는 질문 목록, 챗봇, 상담 번호 등) 정보를 제공함
...
도움 패널을 발견하지 못할 수 있으므로 사용자가 반드시 확인해야 하는 중요한 정보를 도움 패널에만 제공해서는 안 된다. 맥락적 도움말은 필수 정보가 아니라 제공되었을 때 사용자가 더 쉽게 이용하는 데 도움 되는 정보를 제공해야 한다. 필수 정보를 잘 요약하여 본문에 표현하고 관련된 유용한 정보를 도움 패널에 제공한다.
...
__상호작용 가이드라인 도움 패널 실행에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                                                   |
| ------------ | ---------------------------------------------------------------------------------------------------- |
...
__상호작용 가이드라인 도움 패널 내부 콘텐츠 탐색에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Tab 로 구성되어있음__
| 구분  | 설명                                  |
| --- | ----------------------------------- |
...
__상호작용 가이드라인 도움 패널 비활성화에 대한 표로 이동에 대한 표로 구분/설명으로 구성되어있으며 구분 항목은 Click, Enter, Space 로 구성되어있음__
| 구분           | 설명                                                                                                   |
| ------------ | ---------------------------------------------------------------------------------------------------- |
...
| -------- | ----------------------------------------------------------------------------- | -------- | -------------------------------------------------------------------------- |
| 신청하기     | 건축물대장 등·초본 발급                                                                 | 도움패널 유형1 | [도움패널 유형1 html 화면 확인하기 ](../../pattern/sample%5Fappl%5F0301.html "새 창 열기") |
| 도움패널 유형2 | [도움패널 유형2 html 화면 확인하기 ](../../pattern/sample%5Fhelper%5Ftype2.html "새 창 열기") |          |                                                                            |

### 마크업 가이드

#### CSS 선택자

__마크업 가이드 CSS 선택자에 대한 표로 필수/선택으로 구성되어있으며 구분 항목은 전체영역, 영역 전개, 패널 제어 버튼, 패널 본문, 패널 하단으로 구성되어있음__
| 필수       | 선택               |       |         |
| -------- | ---------------- | ----- | ------- |
...
| 함수명                | 설명          |                 |
| ------------------ | ----------- | --------------- |
| krds\_helpPanel    | init()      | 초기화 및 주요 이벤트 실행 |
