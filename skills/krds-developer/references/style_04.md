Title: 형태 (Shape) | 스타일 가이드 - KRDS

URL Source: https://www.krds.go.kr/html/site/style/style_04.html
...
| 12\*12   | 2px                                                                                                   |                |             |                                                                       |
| 16\*16   | 2px                                                                                                   |                |             |                                                                       |
| Small    | 태그, 칩 같은 작은 컴포넌트에서 사용한다.                                                                              | 20\*20         | 4px         | ChipsCheckboxRadio buttonSwitchTag                                    |
| 24\*24   | 4px                                                                                                   |                |             |                                                                       |
| 32\*32   | 4px                                                                                                   |                |             |                                                                       |
| Medium   | 기본이 되는 값으로 주로 버튼, 인풋 등에서 사용한다.                                                                        | 40\*40         | 6px         | ButtonText inputTextareaSelectCarousel-NumberStep indicatorPagination |
| 48\*48   | 6px                                                                                                   |                |             |                                                                       |
| 56\*56   | 6px                                                                                                   |                |             |                                                                       |
| 64\*64   | 6px                                                                                                   |                |             |                                                                       |
| Large    | 주로 카드와 같은 큰 컴포넌트에 사용한다                                                                                | 72\*72         | 10px        | CardDialog                                                            |
| 80\*80   | 10px                                                                                                  |                |             |                                                                       |
| Xlarge   | 가장 큰 값으로 주로 배너, 바텀 시트 같은 화면을 차지하는 비율이 큰 컴포넌트에 사용한다.                                                   | 96\*96         | 12px        | BannerDialogBottom sheet                                              |
| 120\*120 | 12px (max)                                                                                            |                |             |                                                                       |
...
1. 1.기준이 되는 컴포넌트를 기관에 맞는 래디어스 값을 테스트하여 비율 값을 찾는다.
