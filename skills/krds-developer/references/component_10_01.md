Title: 언어 변경 (Language switcher) | 컴포넌트 - KRDS

URL Source: https://www.krds.go.kr/html/site/component/component_10_01.html

Markdown Content:
---
description: 언어 변경은 서비스의 콘텐츠를 표시할 언어를 변경하거나 별도의 외국어 서비스로 이동하는 데 사용되는 요소이다. 한국어가 익숙하지 않은 사용자가 콘텐츠 표시 언어를 변경할 수 있는 수단을 발견하지 못한다면 서비스를 이용할 수 없게 되므로, 디지털 정부서비스로 직관적이고 일관된 방식으로 언어 변경을 제공하는 것이 매우 중요하다.
title: 언어 변경 (Language switcher) | 컴포넌트 - KRDS
...
1. 1.**아이콘과 레이블** 언어 변경 옵션 목록을 실행하는 데 사용하는 버튼/링크의 이름
2. 2.**현재 언어** 현재 표시되고 있는 언어 이름
3. 3.**옵션** 사용자가 선택할 수 있는 표시 언어 옵션 값의 목록. 언어 이름을 ‘원어-현재 서비스를 표시하는 데 사용된 언어’로 작성함
...
__상호작용 가이드라인 드롭다운 목록 확장 및 축소에 대한 표로 구분/내용으로 구성되어있으며 구분 항목은 Click, Enter, Space, Esc으로 구성되어있음__
| 구분           | 내용                                                                                                     |
| ------------ | ------------------------------------------------------------------------------------------------------ |
...
__상호작용 가이드라인 드롭다운 목록 탐색에 대한 표로 구분/내용으로 구성되어있으며 구분 항목은 Tab, Shift + Tab, Scroll로 구성되어있음__
| 구분               | 내용                                          |
| ---------------- | ------------------------------------------- |
...
<!-- Source: https://www.krds.go.kr/html/code/language_switcher.html -->
```html
<!-- language switcher -->
...
* [中文 (중국어)](# "새 창 열림")
* [日本語 (일본어)](# "새 창 열림")
* [français (프랑스어)](# "새 창 열림")

##### 페이지 전환 코드 확인하기

<!-- KRDS-CODE:START 페이지 전환 코드 확인하기 -->
<!-- Source: https://www.krds.go.kr/html/code/language_switcher_page.html -->
```html
<!-- language switcher -->
<div class="krds-drop-wrap krds-language">
  <button type="button" class="krds-btn small text drop-btn">
